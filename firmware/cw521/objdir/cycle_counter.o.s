...
.LFB67:
	.file 1 ".././hal/sam3u1c/cycle_counter.c"
	.loc 1 50 0
	.cfi_startproc
	...
	.loc 1 53 0
	.syntax unified
@ 53 ".././hal/sam3u1c/cycle_counter.c" 1
	loop: DMB	
SUBS R0, R0, #1  
BNE.N loop         
@ 0 "" 2
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 12 ".././hal/sam3u1c/inc/cycle_counter.h"
	.byte	0x3
	.uleb128 0x2c
	.uleb128 0xc
	.byte	0x5
...
.Ldebug_macro101:
	...
	.4byte	.LASF8214
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.cycle_counter.h.95.ed780ab172fe728c3cce1fb4b369fc23,comdat
.Ldebug_macro102:
	.2byte	0x4
	.byte	0
	.byte	0x5
...
.LASF8215:
	...
	.ascii	"(uint64_t)(14e3-1ul)) / (uint64_t)14e3)\000"
.LASF4331:
...
.LASF8218:
	.ascii	"cpu_delay_ms(delay,f_cpu) delay_cycles(cpu_ms_2_cy("
	.ascii	"delay, f_cpu))\000"
.LASF4473:
...
.LASF8354:
	.ascii	".././hal/sam3u1c/cycle_counter.c\000"
.LASF6097:
...
.LASF8216:
	.ascii	"cpu_us_2_cy(us,f_cpu) (((uint64_t)(us) * (f_cpu) + "
	.ascii	"(uint64_t)(14e6-1ul)) / (uint64_t)14e6)\000"
.LASF1823:
